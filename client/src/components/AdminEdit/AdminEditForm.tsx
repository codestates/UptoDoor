...
function AdminEditForm() {
  ...
  const addMenuHandler = (menu: any) => {
    const bin = {
      id: 0,
      image: "./images/icon/menu-add.png",
      name: "",
      price: 0,
      detail: "",
    };
  ...
  useEffect(() => {
    ...
    axios.get(`${END_POINTS}/admin/store/${store_id}`).then((res) => {
        ...
        <Wrapper>
          <FlexBox>
            <AdminForm>
              ...
              <StoreInputBox>
                <label>상호명</label>
                <StoreInput readOnly type="text" defaultValue={title} />
              </StoreInputBox>

              <StoreInputBox>
                <label>카테고리</label>
                <StoreInput readOnly type="text" defaultValue={category} />
              </StoreInputBox>
              ...
              <StoreInputBox>
                <label>
                  배달 가능시간<span>(ex.09:00-17:00)</span>
                </label>
            ...
            <AdminForm>
              ...
              <StoreBtnBox flexable>
                <SmallButton type="submit" primary onClick={submitHandler}>
                  {" "}
                  수정{" "}
                </SmallButton>

                <SmallButton type="button" onClick={deleteModalHandler}>
                  {" "}
                  삭제{" "}
                </SmallButton>
              </StoreBtnBox>
