...
module.exports = async (req, res) => {
  ...
  try {
    ...
    await axios
      .get(
        `https://nid.naver.com/oauth2.0/token?grant_type=authorization_code&client_id=NESPZSGxrp2Y8chEbfUk&client_secret=a5VP580J66&code=${authorizationCode}&state=${state}`
      )
      .then((result) => {
    ...
    await axios
      .post("https://openapi.naver.com/v1/nid/me", null, {
        headers: {
