...
module.exports = async (req, res) => {
  ...
  try {
    await axios
      .post(
        `https://nid.naver.com/oauth2.0/token?grant_type=delete&client_id=NESPZSGxrp2Y8chEbfUk&client_secret=a5VP580J66&access_token=${Data.oauth_token}&service_provider=NAVER`
      )
      .then((result) => {
